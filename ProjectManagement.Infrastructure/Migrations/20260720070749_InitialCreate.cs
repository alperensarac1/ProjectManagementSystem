        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Projects_EndDate", "\"EndDate\" IS NULL OR \"EndDate\" >= \"StartDate\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedHours = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TaskTimeLogs_Hours", "\"Hours\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_ProjectId_UserId_Unique",
                table: "ProjectMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistories_ChangeType",
                table: "TaskHistories",
                column: "ChangeType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTimeLogs_UserId_TaskId_WorkDate",
                table: "TaskTimeLogs",
                columns: new[] { "UserId", "TaskId", "WorkDate" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskTimeLogs_WorkDate",
                table: "TaskTimeLogs",
                column: "WorkDate");
